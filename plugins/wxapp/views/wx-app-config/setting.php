    ...
    <el-card shadow="never" v-loading="cardLoading" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <el-tabs v-model="activeName">
                                ...
                                <div v-if="is_third == 1 && third && have_version">
                                    ...
                                    <div v-loading="app_qrcode_loading" class="program-info" v-if="is_pass">
                                        ...
                                        <div>
                                            ...
                                            <el-button @click="is_pass = false;check_status = -1" :loading="submitLoading" v-if="is_new" class="button">发现新版本，去更新</el-button>
                                        </div>
                                    </div>
                                </div>
                            </el-col>
            ...
            <el-tab-pane label="支付配置" name="second">
                <div class="form_box">
                    <el-row>
                        <el-form :model="ruleForm" :rules="other_rules" size="small" ref="ruleForm2" label-width="150px">
                            <el-col :span="12">
