                        ...
                        <el-col :span="24">
                            ...
                            <div class="form-body">
                                ...
                                <el-form-item>
                                    ...
                                    <div>
                                        <el-radio v-model="ruleForm.setting.show_contact_type" :label="0">关闭</el-radio>
                                        <el-radio v-model="ruleForm.setting.show_contact_type" :label="1">官方客服</el-radio>
                                        <el-radio v-model="ruleForm.setting.show_contact_type" :label="2">外链客服</el-radio>
                                    </div>
                                </el-form-item>
                            </div>
                            <div class="title">
...
<script>
    const app = new Vue({
        ...
        watch: {
            'ruleForm.setting.good_negotiable': function () {
                if (this.ruleForm.setting.good_negotiable.length === 0) {
                    this.ruleForm.setting.good_negotiable.push('contact');
                }
            }
        }
    });
