    ...
    public function rules()
    {
        return [
            ...
            [['contact_tel', 'kdniao_mch_id', 'kdniao_api_key', 'member_integral_rule',
                ...
                'kd100_key', 'kd100_customer', 'kd100_secret', 'kd100_siid', 'print_type', 'auto_open_time', 'auto_open_time'], 'string'],
            [['over_time', 'delivery_time', 'after_sale_time', 'member_integral',
                ...
                'is_show_hot_goods', 'is_open','open_type','is_auto_open', 'show_contact_type'], 'integer'],
            [['name'], 'required',],
            ...
            [['good_negotiable', 'payment_type', 'send_type', 'business_time_type_day', 'business_time_type_week',
                'auto_business_time', 'quick_customize_params', 'quick_customize_new_params', 'send_type_desc', 'time_list', 'week_list'], 'safe'],
    ...
    public function save()
    {
        ...
        try {
            ...
            foreach ($this->attributes as $k => $item) {
                ...
                if (in_array($k, ['good_negotiable', 'payment_type', 'send_type', 'business_time_type_week', 'business_time_type_day', 'quick_customize_new_params', 'send_type_desc', 'week_list', 'time_list'])) {
